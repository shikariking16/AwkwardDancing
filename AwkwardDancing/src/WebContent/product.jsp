...
<html>
<head>
<title>Awkward Dancing - Product Information</title>
...
try 
{
	...
	{		
		...
		String[] artistYear = rst.getString(6).split(" - ");

		out.println("<table style=\"width:20%;\"><tr>");
		out.println("<th>Id</th><td>" + prodId + "</td></tr>"
				+ "<tr><th>Artist</th><td>" + artistYear[0] + "</td></tr>"				
				+ "<tr><th>Year</th><td>" + artistYear[1] + "</td></tr>"				
